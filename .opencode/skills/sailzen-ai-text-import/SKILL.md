---
name: sailzen-novel-processor
description: 完整的小说智能处理与导入系统，支持AI驱动的章节识别、动态脚本生成、质量验收、飞书Bot远程触发和一键上传到服务器。
---

# SailZen 小说智能处理与导入系统

完整的小说文本处理流水线，支持智能章节识别、动态脚本生成、质量验收和一键上传到服务器。可通过飞书 Bot 远程触发 OpenCode session 执行。
