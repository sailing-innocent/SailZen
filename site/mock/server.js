...
const BODY_METRICS = [
  ...
  { key: 'penis_length', labelZh: '起长', labelEn: 'Erose Length', unit: 'cm', category: 'body', precision: 1, min: 1, max: 30, higherIsBetter: true, builtin: true },
  { key: 'penis_circ', labelZh: '起围', labelEn: 'Erose Circ', unit: 'cm', category: 'body', precision: 1, min: 1, max: 30, higherIsBetter: true, builtin: true },
  { key: 'penis_time', labelZh: '起时长', labelEn: 'Erose TimeLen', unit: 'min', category: 'body', precision: 1, min: 1, max: 60, higherIsBetter: true, builtin: true },
