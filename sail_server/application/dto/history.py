...
class HistoryEventBase(BaseModel):
    ...
    tags: List[str] = Field(default_factory=list, description="机器处理后用于检索的标签")
    ...
    related_events: List[int] = Field(default_factory=list, description="相关事件的ID列表")
...
class HistoryEventUpdateRequest(BaseModel):
    ...
    tags: Optional[List[str]] = Field(default=None, description="机器处理后用于检索的标签")
    start_time: Optional[datetime] = Field(default=None, description="估计的开始时间")
    end_time: Optional[datetime] = Field(default=None, description="估计的结束时间")
    related_events: Optional[List[int]] = Field(default=None, description="相关事件的ID列表")
    parent_event: Optional[int] = Field(default=None, description="父事件ID")
