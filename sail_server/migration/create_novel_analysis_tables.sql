...
CREATE INDEX IF NOT EXISTS idx_settings_edition ON settings(edition_id);
...
CREATE INDEX IF NOT EXISTS idx_settings_name_trgm ON settings USING GIN (canonical_name gin_trgm_ops);
