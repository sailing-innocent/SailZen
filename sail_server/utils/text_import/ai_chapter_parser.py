...
from sail_server.utils.text_import.chapter_types import (
    ChapterType, get_chapter_type_by_title, get_standard_chapter_patterns
)
...
只返回 JSON，不要其他说明。"""
    ...
    def _post_process_chapters(self, chapters: List[ParsedChapter]) -> List[ParsedChapter]:
        """后处理章节列表
        ...
        for chapter in chapters:
            ...
            # 超短章节
            if chapter.char_count < avg_length - 3 * std_length or chapter.char_count < 100:
