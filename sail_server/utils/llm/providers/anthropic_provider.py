...
from .base import BaseProvider, ProviderConfig, ProviderResponse, ProviderError, ProviderRateLimitError, ProviderAuthError
    ...
    async def _do_complete(
        ...
        **kwargs
        ...
        if "temperature" in kwargs or self.config.temperature != 0.3:
            call_kwargs["temperature"] = kwargs.get("temperature", self.config.temperature)
        if "top_p" in kwargs:
        ...
        try:
            ...
            response = await loop.run_in_executor(
                None,
                lambda: self._client.messages.create(**call_kwargs)
            )
            ...
            return ProviderResponse(
                ...
                raw_response={
                    ...
                    "type": response.type,
                    "role": response.role,
                } if hasattr(response, 'id') else None,
            )
