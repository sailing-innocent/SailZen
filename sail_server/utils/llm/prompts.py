                    ...
                    "properties": {
                        "plot_points": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    "title": {"type": "string"},
                                    "type": {"type": "string", "enum": ["conflict", "revelation", "climax", "resolution", "setup"]},
                                    "importance": {"type": "string", "enum": ["critical", "major", "normal", "minor"]},
                                    "summary": {"type": "string"},
...
```''',
    ...
    def render(
        ...
        user_prompt = self._render_template_string(template.user_prompt_template, variables)
