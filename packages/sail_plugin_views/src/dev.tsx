...
import { SailProps } from "./types/index";
...
// Component registry
const COMPONENTS: Record<string, React.ComponentType<SailProps>> = {
  SailNotePreview,
  SailCalendarPanel,
};
...
if (VALID_NAMES.includes(VIEW_NAME)) {
  ...
  const mockWorkspace = {
    ...
    ws: "E:\\ws\\repos\\SailSail\\test-workspace",
    browser: true,
    theme: "dark",
  };

  // Create props for the component
  const mockProps: SailProps = {
    engine: mockEngine,
    ide: mockIde,
