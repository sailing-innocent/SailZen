...
const SailCalendarPanel: SailComponent = (props: SailProps) => {
  ...
  const sailDateFormat = journalConfig.dateFormat || "y.MM.dd";
  const journalDateFormat = sailDateFormat.replace(/y/g, "YYYY").replace(/d/g, "D");
...
export default SailCalendarPanel;