...
function SailVSCodeApp({ Component }: { Component: SailComponent }) {
  const ctx = "SailVSCodeApp";
  ...
  const logger = createLogger("SailApp");
...
export type SailAppProps = {
  opts: { padding: "inherit" | number | string };
  Component: SailComponent;
};

// function SailApp(props: SailAppProps) {
//   return (
//     <SailVSCodeApp {...props} />
//   );
// }
