# @saili/Sail Plugin Views

The Frontend UI for Sail Plugin (VSCode Webview)
...
sail_plugin_views/
├── src/
│   ├── components/       # React components (SailNotePreview, SailCalendarPanel, etc.)
...
- `SailNotePreview` - Note preview panel
- `SailCalendarPanel` - Calendar view for daily notes
