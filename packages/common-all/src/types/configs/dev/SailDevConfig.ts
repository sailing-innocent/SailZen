...
export type SailDevConfig = {
  ...
  /**
   * Sets self contained vaults as the default vault type. Sail can read
...
/**
 * Generates defaults for {@link SailDevConfig}
 * @returns SailDevConfig
 */
export function genDefaultDevConfig(): SailDevConfig | undefined {
  return;
}
