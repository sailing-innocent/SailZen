...
import { SailCommandConfig } from "../../types/configs/commands/commands";
import {
  LookupConfig,
  NoteLookupConfig,
 ...
 */
const NOTE: SailConfigEntryCollection<NoteLookupConfig> = {
 ...
 */
const LOOKUP: SailConfigEntryCollection<LookupConfig> = {
  note: NOTE,
};
 ...
 * Random note entries
 */
const RANDOM_NOTE: SailConfigEntryCollection<RandomNoteConfig> = {
  include: {
 ...
 */
const INSERT_NOTE_LINK: SailConfigEntryCollection<InsertNoteLinkConfig> = {
 ...
 */
export const INSERT_NOTE_INDEX: SailConfigEntryCollection<InsertNoteIndexConfig> =
{
  enableMarker: {
    label: `Enable Marker`,
...
const COPY_NOTE_LINK: SailConfigEntryCollection<CopyNoteLinkConfig> = {
  nonNoteFile: {
    label: "Non-note file",
 ...
 */
export const COMMANDS: SailConfigEntryCollection<SailCommandConfig> = {
  lookup: LOOKUP,
