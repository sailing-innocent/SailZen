...
const GITHUB: SailConfigEntryCollection<GithubConfig> = {
  cname: {
    label: "CNAME",
...
const GISCUS: SailConfigEntryCollection<GiscusConfig> = {
  id: {
    label: "ID",
...
const GA: SailConfigEntryCollection<GoogleAnalyticsConfig> = {
  tracking: {
    label: "Tracking",
...
const IMAGE: SailConfigEntryCollection<SEOImage> = {
  url: {
    label: "URL",
    desc: "URL of image",
  },
...
const SEO: SailConfigEntryCollection<SEOConfig> = {
  title: {
    label: "Title",
    desc: "Set SEO title.",
  },
...
export const PUBLISHING: SailConfigEntryCollection<SailPublishingConfig> =
{
  ...
  siteRootDir: {
    label: "Site Root Dir",
    desc: "Where your site will be published, relative to the Sail workspace.",
  },
  siteUrl: {
    label: "Site URL",
