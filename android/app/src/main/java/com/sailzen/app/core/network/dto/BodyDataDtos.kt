...
val BUILTIN_BODY_METRICS: List<BodyMetricDefDto> = listOf(
    ...
    BodyMetricDefDto("penis_length", "起长", "Erose Length", "cm", BodyMetricCategory.body, 1, 1.0, 30.0),
    BodyMetricDefDto("penis_circ", "起围", "Erose Circ", "cm", BodyMetricCategory.body, 1, 1.0, 30.0),
    BodyMetricDefDto("penis_time", "起时长", "Erose TimeLen", "min", BodyMetricCategory.body, 1, 1.0, 60.0),
